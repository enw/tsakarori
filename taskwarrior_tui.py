...
class TaskWarriorTUI:
    def __init__(self):
        ...
        self.projects = []
        self.tags = []
        self.config = taskwarrior_tui_config.Config()
    ...
    def show_help(self, stdscr):
        help_text = [
            ...
            "Available schemes: " + ", ".join(self.config.config['color_schemes'].keys()),
            "",
    ...
    def filter_by_project(self, stdscr):
        ...
        height, width = stdscr.getmaxyx()
        win = curses.newwin(len(self.projects)+4, 40, height//2-len(self.projects)//2, width//2-20)
        win.box()
    ...
    def filter_by_tag(self, stdscr):
        ...
        height, width = stdscr.getmaxyx()
        win = curses.newwin(len(self.tags)+4, 40, height//2-len(self.tags)//2, width//2-20)
        win.box()
